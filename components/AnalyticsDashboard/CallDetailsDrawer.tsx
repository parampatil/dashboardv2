...
import { Clock, User, MapPin, MessageSquare, DollarSign, Hash } from "lucide-react";
...
export const CallDetailsDrawer: React.FC<CallDetailsDrawerProps> = ({ call, onClose }) => {
  if (!call) return null;
  ...
  return (
    <Drawer open={!!call} onOpenChange={onClose}>
        ...
        >
          <DrawerHeader className="border-b pb-4">
            <div className="flex justify-between items-center">
              <div>
                <DrawerTitle className="text-xl font-bold">Call Details</DrawerTitle>
              ...
              <Badge className={`${getStatusBadgeClass(call.callStatus)} px-3 py-1`}>
                {call.callStatus}
              </Badge>
            </div>
          </DrawerHeader>
            ...
            <Tabs defaultValue="basic" className="w-full px-4 py-2">
              ...
              <TabsContent value="basic" className="space-y-4">
                ...
                <motion.div
                  ...
                  variants={fadeInVariants}
                >
                  <h3 className="text-sm font-medium text-gray-500 mb-2">Session ID</h3>
                  <CopyTooltip
...
const TimelineItem: React.FC<{ label: string; time: string; isLast?: boolean }> = ({ 
  ...
  >
    <div className="mr-3 relative">
      ...
      {!isLast && <div className="h-full w-0.5 bg-gray-200 absolute top-4 left-1.5"></div>}
    </div>
